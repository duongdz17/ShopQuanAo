...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5">
			...
			List<SanPham> sanPhams = sanPhamDAO.getSanPhamByDanhMuc(madanhmuc);
			%>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                ...
                                <a href="addGioHangp3?masanpham=<%=sanPham.getMasanpham() %>" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Thêm vào giỏ hàng</a>
                            </div>
                        </div>
                    </div>
                    <%} %>
